...
PFont font;
String letters = "These words go round and around and around and around because I need to change the structure of this program. Round and round";
int fontSizeMin = 1;
...
void setup() {
  ...
  PImage img;
  img = loadImage("maze.gif");
  image(img, 25, 25, 450, 450 );

  x = mouseX;
  y = mouseY;

  font = createFont("BanglaMN-Bold-24",10);
